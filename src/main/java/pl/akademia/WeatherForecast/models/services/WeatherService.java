package pl.akademia.WeatherForecast.models.services;

import org.json.JSONArray;
import org.json.JSONObject;
import pl.akademia.WeatherForecast.models.Utils;
import pl.akademia.WeatherForecast.models.WeatherModel;
...
public class WeatherService {
    ...
    public List<WeatherModel> getWeather(final String cityName){
        String websiteResponse = Utils.readWebsiteContent("http://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&appid=6fe388a81433d1c1d7efecb1609da4eb");
    ...
    private List<WeatherModel> getForecast(String cityName) {
        String websiteResponse = Utils.readWebsiteContent("http://api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&mode=json&appid=6fe388a81433d1c1d7efecb1609da4eb");
        String description = null;
        int temperature;
        int humidity;
        int pressure;
